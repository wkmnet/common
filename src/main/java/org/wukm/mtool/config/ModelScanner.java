...
public class ModelScanner{
    ...
    private Logger logger = LoggerFactory.getLogger(ModelScanner.class);
    ...
    public List<String> loadClasses(){
        try{
            return getFullyQualifiedClassNameList();
        } catch (Exception e){
    ...
    private List<String> doScan(String basePackage, List<String> nameList) throws IOException {
        ...
        String splashPath = StringUtils.replace(basePackage,".","/");

        // get file path
        URL url = classLoader.getResource(splashPath);
        String filePath = CommonUtil.getRootPath(url);
    ...
    public List<String> getFullyQualifiedClassNameList() throws IOException {
        ...
        for(String basePackage:packageNames) {
            ...
            dest.addAll(doScan(basePackage, new ArrayList<>()));
        }
        return dest;
    }
    ...
    private String toFullyQualifiedName(String shortName, String basePackage) {
        ...
        sb.append('.');
        sb.append(CommonUtil.trimExtension(shortName));
        return sb.toString();
    }
